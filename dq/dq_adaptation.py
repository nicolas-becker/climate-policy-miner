...
def export_analysis_report(df, output_path):
    ...
    with pd.ExcelWriter(output_path, engine='openpyxl') as writer:
        ...
        # Category-Measure relationship analysis
        ...
        # Activity type by Category analysis
        if 'Category' in df.columns and 'Activity type' in df.columns:
            ...
            activity_cat.to_excel(writer, sheet_name='Activity by Category', index=False)
        ...
        if 'Country Code' in df.columns and 'Measure' in df.columns:
            ...
            measure_country.to_excel(writer, sheet_name='Measure by Country', index=False)
        ...
        if 'Country Code' in df.columns and 'Category' in df.columns:
            ...
            category_country.to_excel(writer, sheet_name='Category by Country', index=False)
